    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error logout ! try again');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " update successfuly"));
          }
          _context.next = 11;
          break;
        case 8:
...
var stripe = Stripe('pk_test_51NxQCNJx780ERXsfRWY96yiau2Mrn3Q4bBEPAo85SQMiBBNRuxnmY66fZPfVgkCN0cyENLRa7SiBwraPM4uRUZkc00lUH3B1Z4');
...
var updatePasswordData = document.querySelector('.form-user-settings');
...
if (updateFormData) updateFormData.addEventListener('submit', function (e) {
  e.preventDefault();
